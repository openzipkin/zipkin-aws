...
final class DynamoDBSpanStore implements SpanStore {
  ...
  @Override public Call<List<String>> getServiceNames() {
    ...
    return new GetSearchKeyCall(executor, dynamoDB, searchTableName, SERVICE_SPAN_ENTITY_TYPE,
  ...
  @Override public Call<List<String>> getSpanNames(String s) {
    ...
    return new GetSearchValueCall(executor, dynamoDB, searchTableName,
        SERVICE_SPAN_ENTITY_TYPE,
        s.toLowerCase(), Collections.singletonList(UNKNOWN));
  }
