...
and
[module jar for the xray storage](https://search.maven.org/remote_content?g=io.zipkin.aws&a=zipkin-module-storage-xray&v=LATEST&c=module).
...
$ curl -sSL https://zipkin.io/quickstart.sh | bash -s io.zipkin.aws:zipkin-module-storage-xray:LATEST:module xray.jar
$ STORAGE_TYPE=xray \
    java \
...
[reference](https://github.com/openzipkin/zipkin-aws/tree/master/module/storage-xray/src/main/resources/zipkin-server-xray.yml)
