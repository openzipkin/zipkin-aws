...
and
[module jar for the sqs collector](https://search.maven.org/remote_content?g=io.zipkin.aws&a=zipkin-module-collector-sqs&v=LATEST&c=module).
...
[reference](https://github.com/openzipkin/zipkin-aws/tree/master/module/collector-sqs/src/main/resources/zipkin-server-sqs.yml)
