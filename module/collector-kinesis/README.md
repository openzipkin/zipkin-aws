# module-collector-kinesis

## ZipkinKinesisCollectorModule
...
and
[module jar for the kinesis collector](https://search.maven.org/remote_content?g=io.zipkin.aws&a=zipkin-module-collector-kinesis&v=LATEST&c=module).
...
$ curl -sSL https://zipkin.io/quickstart.sh | bash -s io.zipkin.aws:zipkin-module-collector-kinesis:LATEST:module kinesis.jar
...
[reference](https://github.com/openzipkin/zipkin-aws/tree/master/module/collector-kinesis/src/main/resources/zipkin-server-kinesis.yml)
